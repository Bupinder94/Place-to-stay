...
function updateAuthUI(username: string | null): void {
  ...
  const message = document.getElementById('logged-in-message') as HTMLSpanElement;
...
function initSearch(): void {
  ...
  form.addEventListener('submit', async (e) => {
    ...
    const type = (document.getElementById('type-input') as HTMLSelectElement).value;
...
function initBookingModal(): void {
  const modal = document.getElementById('booking-modal') as HTMLDivElement;
  ...
  form.addEventListener('submit', async (e) => {
    e.preventDefault();
    const accID = (document.getElementById('booking-acc-id') as HTMLInputElement).value;
    const dateInput = (document.getElementById('booking-date') as HTMLInputElement).value;
    const npeople = (document.getElementById('booking-people') as HTMLInputElement).value;

    if (!dateInput) {
      const msgDiv = document.getElementById('booking-message') as HTMLDivElement;
...
function openBookingModal(accID: number, accName: string): void {
  const modal = document.getElementById('booking-modal') as HTMLDivElement;
  (document.getElementById('booking-acc-id') as HTMLInputElement).value = accID.toString();
  (document.getElementById('booking-acc-name') as HTMLParagraphElement).textContent = accName;
  (document.getElementById('booking-message') as HTMLDivElement).textContent = '';
